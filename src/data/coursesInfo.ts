...
export default {
  ...
  "EECS-2001": {
    ...
    credits: 3,
    prerequisites: [
      ["EECS-1021", "EECS-1022", "EECS-1720", "EECS-1030"],
      ["EECS-1028", "MATH-1028", "EECS-1019", "MATH-1019"],
    ],
    courseCreditExclusions: [],
  },
  "EECS-2011": {
  ...
  "EECS-3201": {
    ...
    prerequisites: [
      ["EECS-1021", "EECS-1022"],
      ["PHYS-1012", "PHYS-1412", "PHYS-1422", "PHYS-1801", "PHYS-1010"],
    ],
    courseCreditExclusions: [],
  },
  "EECS-3121": {
    ...
    credits: 3,
    prerequisites: [
      ["MATH-1010", "MATH-1014", "MATH-1310"],
      ["MATH-1021", "MATH-1025", "MATH-2221"],
      ["EECS-1540", "EECS-2031", "EECS-2501"],
    ],
  ...
  "EECS-3431": {
    ...
    year: 3,
    description:
      'Introduces the fundamental concepts and algorithms of three-dimensional computer graphics, including object modelling, transformations, cameras, visibility and shading. Prerequisites: Cumulative GPA of 4.50 or better over all major EECS courses (without second digit "5"); LE/EECS 2030 3.00; SC/MATH 1025 3.00. Course credit exclusions: AK/AS/SC/CSE 4431 3.00.',
    credits: 3,
