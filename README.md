...
Runs eslint on the src directory of the project. Fixes issues that can be resolved automatically and provides a warning for issues that must be resolved manually.
